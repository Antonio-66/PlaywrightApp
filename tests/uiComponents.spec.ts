...
test('web tables', async({page}) => {
    ...
    await page.locator('input-editor').getByPlaceholder('E-mail').fill('atrini@gmail.com')
    await page.locator('.nb-checkmark').click()
    await expect(targetRowById.locator('td').nth(5)).toHaveText('atrini@gmail.com')
...
test('sliders', async ({page}) => {
    ...
    await tempGauge.evaluate( node => {
        node.setAttribute('cx','268.137')
        node.setAttribute('cy','112.763')
    })
